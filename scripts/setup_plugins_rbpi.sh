...
apt-get -y install bchoppr beatslash-lv2 blop-lv2 bsequencer boops/buster bshapr bslizr
...
apt-get -y install regrader riban-lv2/buster rubberband-lv2 safe-plugins shiro-plugins sorcer
